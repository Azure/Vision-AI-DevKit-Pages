...
* For VS Code based deployment you also need to clone or download [Vision AI Developer Kit GitHub](https://github.com/Microsoft/vision-ai-developer-kit) contents. It contains the script needed for deployment.
