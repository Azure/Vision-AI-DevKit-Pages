...
- Select the *iothack* Wi-Fi network your camera will connect to from the drop down box and then enter the Wi-Fi passphrase *iothack1*. You will see a confirmation screen when the camera successfully connects to your selected Wi-Fi network.
